...
<body>
<img src="img/spy.png" width="16" height="16"><br>
<div id="screen"></div>
<br><br>
<div id="control">
  ...
  <input  type="button" value="?" onclick="alert('Licence GPL. \n https://github.com/vernetit/spyReader \ncontact: robertchalean@gmail.com');">
...
<script src='js/app/spyReader.js'></script>
